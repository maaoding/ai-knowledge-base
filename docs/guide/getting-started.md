...
- **应用实践。** [Prompt 入门](/prompting/basics)、[效果评估](/prompting/evaluation)、[RAG 与 Agent](/llm/rag-agent)、[工作流和模板区别](/workflows/workflow-vs-template)、[常用工具](/tools/common-tools)，用于把模型能力组织成明确、可验证、可复用的任务流程。
